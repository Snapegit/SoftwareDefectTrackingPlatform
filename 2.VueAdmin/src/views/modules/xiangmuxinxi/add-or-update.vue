	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="项目类别" prop="xiangmuleibie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.xiangmutupian" label="项目图片" prop="xiangmutupian">
					<file-upload
						tip="点击上传项目图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.xiangmutupian" label="项目图片" prop="xiangmutupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.xiangmuziliao" label="项目资料" prop="xiangmuziliao">
					<file-upload
						tip="点击上传项目资料"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangmuziliao" label="项目资料" prop="xiangmuziliao">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#385d86","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.xiangmuziliao)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="!ruleForm.xiangmuziliao" label="项目资料" prop="xiangmuziliao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="创建时间" prop="chuangjianshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chuangjianshijian" label="创建时间" prop="chuangjianshijian">
					<el-input v-model="ruleForm.chuangjianshijian" placeholder="创建时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="项目介绍" prop="xiangmujieshao">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangmujieshao" label="项目介绍" prop="xiangmujieshao">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xiangmujieshao}}</span>
				</el-form-item>
