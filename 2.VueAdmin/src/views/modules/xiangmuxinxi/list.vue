<template>
	<div class="main-content" :style='{"padding":"30px"}'>
		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='false' prop="xiangmutupian" width="200" label="项目图片">
						<template slot-scope="scope">
					...
					<el-table-column :resizable='false' :sortable='false' prop="xiangmuziliao" label="项目资料">
						<template slot-scope="scope">
							<el-button v-if="scope.row.xiangmuziliao" type="text" size="small" @click="download(scope.row.xiangmuziliao)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='false'  
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('xiangmuxinxi','问题提交')" @click="quexianwentiCrossAddOrUpdateHandler(scope.row,'cross','','','')" type="success">
								<span class="icon iconfont " :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
								问题提交
							</el-button>
		...
		<quexianwenti-cross-add-or-update v-if="quexianwentiCrossAddOrUpdateFlag" :parent="this" ref="quexianwentiCrossaddOrUpdate"></quexianwenti-cross-add-or-update>
...
import quexianwentiCrossAddOrUpdate from "../quexianwenti/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				quexianwentiCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			quexianwentiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.quexianwentiCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.quexianwentiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.quexianwentiCrossaddOrUpdate.init(row.id,type);
				});
			},
