		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">缺陷名称</label>
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='false' prop="quexiantupian" width="200" label="缺陷图片">
						<template slot-scope="scope">
							<div v-if="scope.row.quexiantupian">
								<img v-if="scope.row.quexiantupian.substring(0,4)=='http'" :src="scope.row.quexiantupian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.quexiantupian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='false'  
						...
						label="管理项目">
						<template slot-scope="scope">
							{{scope.row.guanlixiangmu}}
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='false' prop="quexianziliao" label="缺陷资料">
						<template slot-scope="scope">
							<el-button v-if="scope.row.quexianziliao" type="text" size="small" @click="download(scope.row.quexianziliao)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='false'  
