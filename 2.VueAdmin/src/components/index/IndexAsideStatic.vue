<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-active="activeMenu" :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0 0 80px","listStyle":"none","overflow":"hidden","borderRadius":"0 0 4px 4px","background":"none","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
