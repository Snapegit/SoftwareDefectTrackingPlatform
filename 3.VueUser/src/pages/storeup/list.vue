...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"#fff","fontSize":"22px","lineHeight":"54px","fontWeight":"600"}'>我的收藏</div>
