...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="用户操作" prop="operation">
            <el-input  v-model="ruleForm.operation" 
                placeholder="用户操作" clearable :readonly=" false  ||ro.operation"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="请求方法" prop="method">
            <el-input  v-model="ruleForm.method" 
                placeholder="请求方法" clearable :readonly=" false  ||ro.method"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="请求时长(毫秒)" prop="time">
            <el-input  v-model="ruleForm.time" 
                placeholder="请求时长(毫秒)" clearable :readonly=" false  ||ro.time"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="IP地址" prop="ip">
            <el-input  v-model="ruleForm.ip" 
                placeholder="IP地址" clearable :readonly=" false  ||ro.ip"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="请求参数" prop="params">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="请求参数"
