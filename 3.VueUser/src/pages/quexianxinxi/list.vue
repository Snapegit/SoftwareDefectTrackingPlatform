...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"0 10px 10px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>缺陷名称：</div>
	  ...
	  <el-button v-if="btnAuth('quexianxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#ad978a","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/quexianxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"border":"1px solid #654B3C","minHeight":"800px","padding":"10px 0","margin":"10px 0 0","background":"#fff","flex":"1","width":"calc(100% - 270px)","order":"4"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
			<div :style='{"border":"1px solid #654B3C","padding":"10px","margin":"10px 1.5%","overflow":"hidden","background":"#ffff","flexDirection":"column","display":"flex","width":"22%","position":"relative","height":"335px"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<img @click.stop="imgPreView(item.quexiantupian)" :style='{"width":"100%","objectFit":"cover","display":"block","height":"170px"}' v-if="item.quexiantupian && item.quexiantupian.substr(0,4)=='http'" :src="item.quexiantupian.split(',')[0]" class="image" />
				<img @click.stop="imgPreView(baseUrl + (item.quexiantupian?item.quexiantupian.split(',')[0]:''))" :style='{"width":"100%","objectFit":"cover","display":"block","height":"170px"}' v-else :src="baseUrl + (item.quexiantupian?item.quexiantupian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 10px","lineHeight":"20px","fontSize":"14px","color":"#333"}' class="name ">缺陷名称:{{item.quexianmingcheng}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
		this.$http.get('quexianleibie/list',{}).then(res => {
		  if (res.data.code == 0) {
		    this.fenlei = res.data.data.list
		  }
		});
		this.feileiColumn = 'quexianleibie'
      },
      getList(page, fenlei, ref = '') {
        ...
        if (this.curFenlei != '全部') searchWhere.quexianleibie = this.curFenlei;
